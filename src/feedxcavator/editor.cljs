...
(defn ^:export main []
  (let [article-lbl (goog.ui.Tooltip. "article-lbl" )]
    (.setHtml article-lbl "Headline encompassing element which contains other
